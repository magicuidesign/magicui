...
export function ComponentInstallation({
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4 mt-8 sm:gap-6">
        <a className="flex w-full flex-col items-center rounded-xl border bg-card p-6 text-card-foreground shadow transition-colors hover:bg-muted/50 sm:p-10" href="/docs/installation/react">
            ...
            <p className="font-medium mt-2">React.js</p>
        </a>
