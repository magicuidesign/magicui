  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center rounded-lg border bg-background p-20 shadow-2xl">
      <ShimmerButton shadowEnabled={false}>
        <span className="pointer-events-none z-[1] whitespace-pre-wrap bg-gradient-to-b from-black from-30% to-gray-300/80 bg-clip-text text-center text-2xl font-semibold leading-none tracking-tight text-transparent dark:from-white dark:to-slate-900/10">
          Shimmer Button
        </span>
      </ShimmerButton>
