...
```bash
npx shadcn@canary add "https://magicui.design/r/marquee"
```
...
If your component is in the `components/ui` directory, the import path should be:

```tsx
import { Marquee } from "@/components/ui/marquee";
```

If your component is in the `components/magicui` directory, the import path should be:
