...
<input
        ...
        type="search"
        placeholder="Search..."
        className="block w-full rounded-md border-0 bg-gray-100 py-2 pl-10 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm"
      />
</div>
);
}
...
const SearchInput: React.FC<SearchInputProps> = ({ icon, placeholder = "Search...", onSearchChange }) => {
