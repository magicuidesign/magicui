...
tags:
  ...
  - react router
  - magic ui
publishedOn: "2025-09-28T07:18:48.832648+00:00"
featured: true
---
...
<li><NavLink to="/features" className={({isActive}) => isActive ? styles.activeLink : ''}>Features</NavLink></li>
<li><NavLink to="/pricing" className={({isActive}) => isActive ? styles.activeLink : ''}>Pricing</NavLink></li>
</ul>
{/* ... buttons */}
</nav>
);
