...
@keyframes pulse-ripple {
  0%   { box-shadow: 0px 0px 0px 0px oklch(from var(--pulse-color, var(--bg)) l c h / 1); }
  100% { box-shadow: 0px 0px 0px var(--distance) oklch(from var(--pulse-color, var(--bg)) l c h / 0); }
}
}
```
