...
<<<<<<< HEAD:apps/www/content/docs/components/typing-animation.mdx

````tsx showLineNumbers
=======
```tsx
// Single string animation
>>>>>>> 65e3f543 (feat(typing-animation): add multi-word animation and cursor control):content/docs/components/typing-animation.mdx
